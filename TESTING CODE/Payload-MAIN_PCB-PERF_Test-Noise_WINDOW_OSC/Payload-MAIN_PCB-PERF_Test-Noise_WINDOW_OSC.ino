 ...
 * 04/08: Code commented out to set up WCK through external OSC at 32768 Hz with WINDOW of 4096 pulses
 * 
 * 
*/
...
void loop() {
  ...
  //Clock_set_readout();                                                                                                                      // $$ External OSC
...
void fgdos_init(byte sensor){
  ...
  // comment the line above and uncomment the line below to get a WINDOW of 32768 pulses
  //Serial.print("-target ("); Serial.print(TARGET_FREQ); Serial.print(") , "); Serial.println((reg_target << 13)*WINDOW_FACTOR);             // $$ Longest WINDOW for low noise
  ...
  // comment the line above and uncomment the line below to get a WINDOW of 32768 pulses
  // Serial.print("-threshold ("); Serial.print(THRESHOLD_FREQ); Serial.print(") , "); Serial.println((reg_threshold << 13)*WINDOW_FACTOR);      // $$ Longest WINDOW for low noise
