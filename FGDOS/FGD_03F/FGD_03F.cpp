...
void spi_setup(){
  ...
  // note: begintransaction and end it should be wrapped around each call, if you want to use other SPI settings, buses, etc.
  // max sensor FGD_03F spi clock speed is 5 MHz, both not chip select pins are put to high to start with
  SPI.begin();
