...
// 29/03: Adapting it to FGD_03F
// 31/03:  debugging with FGD_03F breakout

// 08/04: Debugging successful, the NSTBY pin needs to be set high for the FGD_03F at the beginning, in order to prevent zeros and garbage values
// 21/04: Some modifications to add readout for Sensor 1, freq register values no longer printed to serial terminal

/* WdM:
 * Changes wrt v01
 * - removed recharge test loop
...
#define RECHARGE_WINDOW 0x0B                                                                         //REF_WINDOW 0x0B
#define CHARGE_SENS 0x0C
#define RECHARGE_REF 0x0D                                                                           //RECHARGE 0x0D
