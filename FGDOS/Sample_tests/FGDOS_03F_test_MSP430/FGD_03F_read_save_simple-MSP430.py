...
def main():
    ...
    datafile = "E:\SPACEFLIGHT TU DELFT\THESIS\LUNAR ZEBRO\Assembly, Integration and Testing\FGDOS Radiation Testing\Test Data\Data Logging & Processing\Arduino_CSV\\FGDOS_03F_HIGH_B3_1_MOCK" + date_time + ".csv"

    # connect with Arduino
    launchpad_port = "COM13"  # serial port of Arduino
    baud = 9600 # set at same rate as in Arduino program
    ser = serial.Serial(launchpad_port, baud, timeout=0.1)
    print("Connected to MSP430 Launchpad port: " + launchpad_port)
