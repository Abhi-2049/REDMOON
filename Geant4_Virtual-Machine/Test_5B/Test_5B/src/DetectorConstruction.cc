...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
  ...
  // Envelope parameters
  //
  G4double env_sizeXY = 100*cm, env_sizeZ = 100*cm;												// $$  G4double env_sizeXY = 20*cm, env_sizeZ =30*cm;
...
//////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  //
  // Shape 5 - Solar Panel Plate (SPP) - CMC Material - Box - 0.2 cm X 17.5 cm X 33.5 cm
  //
