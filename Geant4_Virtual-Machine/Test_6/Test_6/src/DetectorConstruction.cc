...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
  ...
  // Envelope parameters
  //
  G4double env_sizeXY = 1000*cm, env_sizeZ = 1000*cm;												// $$  G4double env_sizeXY = 20*cm, env_sizeZ =30*cm;
...
//////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  //Element definition (for FR4 ) 
  //density = 1.2*g/cm3; 
  //G4Element* el_O = new G4Element("Oxygen","O", z=8, 16.00*g/mole);
	//G4Element* el_Si = new G4Element("Silicon","O", z=8, 16.00*g/mole);  
